...
<div href="createalbum.php" class="rounded bg-gray-700 text-gray-200 mx-auto p-4 hover:bg-gray-200 hover:text-gray-700 hover:shadow-outline"> <a href="createalbum.php"> Create album + </a> </div>
</div>